...
using Accounting.Web.Utils.Web;
using Accounting.Web.Utils.Web.Middlewares.Rewinding;
using Accounting.Web.Utils.Web.Middlewares.Tracing;
using Accounting.Web.Utils.Web.Swagger;
            ...
            webHostBuilder
                ...
                .Configure(
                    (context, appBuilder) =>
                    {
                        ...
                        appBuilder.Map(
                            config.InternalApiConfig.RoutePrefix
                            , pipeline =>
                            {
                                pipeline
