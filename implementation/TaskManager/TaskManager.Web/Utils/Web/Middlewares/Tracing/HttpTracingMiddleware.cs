...
namespace TaskManager.Web.Utils.Web.Middlewares.Tracing
{
    /// <summary>
    ...
    internal class HttpTracingMiddleware
    {
        ...
        {
            var body = EndpointIsDecoratedWith<DoNotTraceRequestBodyAttribute>(context) ? "<skipped>" : await context.ReadRequestAsync();
        ...
        {
            var body = EndpointIsDecoratedWith<DoNotTraceResponseBodyAttribute>(context)
                ? "<skipped>"
                : await context.ReadResponseAsync();
