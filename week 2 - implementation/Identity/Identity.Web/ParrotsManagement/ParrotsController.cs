using Identity.Application.UseCases.ChangeParrotRole;
using Identity.Application.UseCases.CreateParrot;
using Identity.Application.UseCases.GetParrot;
using Identity.Application.UseCases.GetParrots;
using Identity.Application.UseCases.RemoveParrot;
